...
public class TemplateEmail {
	...
	public String emailEnviar(String conteudo){
		...
		email = email + "<img src=\"http://52.41.8.255:8080/dadosesocial/img/logo.png\" alt=\"\" />";
		email = email + "</td>";
		email = email + "<td width=\"50\" bgcolor=\"#dbe1d3\"></td>";
		email = email + "</tr>";
		email = email + "<table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\" class=\"content-wrap\">";
		...
		email = email + "<p style=\"margin-left:50px;\"></p>";
		email = email + "</td>";
		email = email + "</tr>";
		email = email + "</table>";
		email = email + "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">";
